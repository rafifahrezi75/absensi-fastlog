...
export default function Login({ errors: propErrors }) {
    ...
    useEffect(() => {
        document.title = "Login - Fastlog Era Mandiri";
    }, []);
        ...
        <div className="min-h-screen flex flex-col lg:flex-row font-sans antialiased bg-gray-50">
                ...
                <div className="relative lg:w-1/2 min-h-[380px] lg:min-h-screen flex flex-col justify-between p-8 md:p-12 overflow-hidden">
                    <div className="absolute inset-0">
                        <img src="/images/front-end/fastlog2.jpg" alt="Fastlog Era Mandiri" className="w-full h-full object-cover" />
                    ...
                    {/* Logo */}
                    <div className="relative flex items-center gap-3 mb-4 lg:mb-0">
                        <img src="/images/front-end/logo2.png" alt="Fastlog Era Mandiri" className="h-14 w-auto object-contain" />
                    </div>
                    ...
                    <p className="relative text-white/30 text-xs">
                        © {new Date().getFullYear()} PT Fastlog Era Mandiri — Fast & Trusted Logistic Partner
                    </p>
                </div>
                    ...
                    <div className="relative w-full max-w-md">
                        ...
                        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-2xl shadow-[#052B35]/10 border border-white/50 p-8 md:p-10">
                            ...
                            {(errors && Object.keys(errors).length > 0) && (
                                <div className="bg-rose-50 border border-rose-100 text-rose-600 text-sm rounded-xl px-4 py-3 mb-6">
                            ...
                            <form onSubmit={submit} className="space-y-5">
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center gap-2 text-sm text-gray-500 cursor-pointer">
                                        <input 
                                            type="checkbox" 
                                            className="rounded border-gray-300 text-[#FF7A3D] focus:ring-[#FF7A3D]/20"
                                ...
                                <button 
                                    type="submit" 
                                    disabled={processing}
                                    className="w-full bg-[#052B35] hover:bg-[#083C4A] text-white font-semibold py-3.5 rounded-xl transition shadow-lg shadow-[#052B35]/20 text-sm disabled:opacity-70 disabled:cursor-not-allowed">
                                    Masuk
                                </button>
                            </form>
                        </div>
                        ...
                        <p className="text-center text-xs text-gray-400 mt-6">
                            © {new Date().getFullYear()} PT Fastlog Era Mandiri · Sistem Absensi Karyawan
                        </p>
